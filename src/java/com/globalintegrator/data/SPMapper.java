...
/*******************************************************************************************************************************/
     ...
     * @return
     */
    @Select(value= "{ CALL BENEFICIARIO_FATCA.Consulta_Estado_Beneficiario( #{NumPoliza, mode=IN, jdbcType=INTEGER}, #{RutBeneficiario, mode=IN, jdbcType=VARCHAR}, #{NumSiniestro, mode=IN, jdbcType=INTEGER}, #{FkIdSistOrigen, mode=IN, jdbcType=INTEGER}, #{Res, mode=OUT, jdbcType=VARCHAR}, #{Estado, mode=OUT, jdbcType=VARCHAR})}")
    @Options(statementType = StatementType.CALLABLE)
     ...
     * @return
     */
    @Select(value= "{ CALL BENEFICIARIO_FATCA.Update_Estado_Beneficiario( #{NumPoliza, mode=IN, jdbcType=INTEGER}, #{RutBeneficiario, mode=IN, jdbcType=VARCHAR}, #{NumSiniestro, mode=IN, jdbcType=INTEGER}, #{FkIdSistOrigen, mode=IN, jdbcType=INTEGER}, #{FkIdEstadoNew, mode=IN, jdbcType=INTEGER}, #{res, mode=OUT, jdbcType=VARCHAR} )}")
    @Options(statementType = StatementType.CALLABLE)                      
