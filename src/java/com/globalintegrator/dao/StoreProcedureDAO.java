...
public class StoreProcedureDAO {
     ...
     * @return
     */
    public String actualizaBeneficiarioAnnotations(int In_Num_Poliza, String In_Rut_Beneficiario, int In_Num_Siniestro, int In_Num_Propuesta, String In_Nom1, String In_Nom2, String In_Apellido1, String In_Apellido2, String In_Nacionalidad1, String In_Nacionalidad2, String In_Nacionalidad3, int In_Fecha_Nacimiento, String In_Pais_Nacimiento, String In_Tin, String In_Dir_Usa, String In_Ciudad_Usa, String In_Estado_Usa, String In_Cod_Postal_Usa, String In_Fono_Usa, int In_Envio_Order, int In_Poder_Notarial, String In_Dir_Cp, String In_Ciudad_Cp, String In_Estado_Cp, String In_Cod_Postal_Cp, int In_Fecha_Form, int In_Monto_Poliza) {
        /**       
         * Llama a session de Base de datos obtenida en
         * MyBatisConnectionFactory.java.
         */
...
/**
     ...
     * @return
     */
    public String consultaEstadoBeneficiarioAnnotations(int NumPoliza, String RutBeneficiario, int NumSiniestro, int SistemaOrigen) {
        ...
        try {
            ...
            consultaEstado.setFkIdSistOrigen(SistemaOrigen);
     ...
     * @return
     */
    public String actualizaEstadoBeneficiarioAnnotations(int NumPoliza, String RutBeneficiario, int NumSiniestro, int SistemaOrigen, int FkIdEstadoNew) {
        ...
        try {
            ...
            actualizaEstado.setFkIdSistOrigen(SistemaOrigen);
